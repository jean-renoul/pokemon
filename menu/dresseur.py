...
def dresseur(screen):
    ...
    background = pygame.image.load('menu/image/dresseur.png')
    
    # Chargement de l'image pour la première pokeball et ajustement de la taille
    pokeball1_image = pygame.image.load('menu/image/pokeball.png')  
    ...
    pokeball2_image = pygame.image.load('menu/image/pokeball.png')  
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if pokeball1_rect.collidepoint(event.pos) or pokeball2_rect.collidepoint(event.pos):
                   ...
                   # Ajoutez ici le code pour la suite du programme après le clic sur une pokeball
