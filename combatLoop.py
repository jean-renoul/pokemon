...
def lancer_combat(pokemon_joueur1, pokemon_joueur2,):
    ...
    while running:
            ...
            if tour_joueur and event.type == pygame.MOUSEBUTTONDOWN:
                if event.button == 1:
                    ...
                    if event.pos[0] > 500 and event.pos[0] < 800 and event.pos[1] > 320 and event.pos[1] < 350:                        
                        ...
                        if combat.calculer_modifier(pokemon1, pokemon2, pokemon1.move1) == 2:
                            afficher_infos(f"C'est super efficace !")
                        elif combat.calculer_modifier(pokemon1, pokemon2, pokemon1.move1) == 0.5:
                    ...
                    if event.pos[0] > 500 and event.pos[0] < 800 and event.pos[1] > 370 and event.pos[1] < 400:
                        ...
                        if combat.calculer_modifier(pokemon1, pokemon2, pokemon1.move2) == 2:
                            afficher_infos(f"C'est super efficace !")
                        elif combat.calculer_modifier(pokemon1, pokemon2, pokemon1.move2) == 0.5:
                            afficher_infos(f"C'est pas très efficace...")
        ...
        if not tour_joueur:
            ...
            if combat.calculer_modifier(pokemon2, pokemon1, choix_move) == 2:
                afficher_infos(f"C'est super efficace !")

            elif combat.calculer_modifier(pokemon2, pokemon1, choix_move) == 0.5:
                afficher_infos(f"C'est pas très efficace...")
